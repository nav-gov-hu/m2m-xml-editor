 ...
 *
 * <p>A {@code JsonAccessDeniedHandler} osztály a web modul biztonsági és jogosultságkezelési területéhez tartozik. A típus a réteg felelősségi határain belül tartja a hozzá tartozó adatokat és műveleteket, és nem helyettesíti az alacsonyabb szintű modulok üzleti szolgáltatásait.</p>
 */
public class JsonAccessDeniedHandler implements AccessDeniedHandler {

    /**
     * A {@code handle} művelet kezeli a kapcsolódó eseményt vagy feldolgozási ágat.
     *
     ...
     * @param accessDeniedException a művelet bemeneti {@code accessDeniedException} értéke
    ...
    public void handle(HttpServletRequest request, HttpServletResponse response,
        ...
        response.getWriter().write("{\"code\":\"ACCESS_DENIED\",\"message\":\"Nincs jogosultságod a művelet végrehajtásához.\"}");
    }
