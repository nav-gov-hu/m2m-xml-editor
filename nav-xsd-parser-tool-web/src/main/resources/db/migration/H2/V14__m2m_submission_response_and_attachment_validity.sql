...
alter table m2m_submission add column nav_megjegyzes clob;
alter table m2m_submission add column nav_validacios_hibak clob;
alter table m2m_submission add column nav_response_body clob;
...
alter table m2m_attachment add column nav_upload_result_message clob;
