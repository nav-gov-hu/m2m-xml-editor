...
alter table m2m_submission add column m2m_submit_marked_at timestamp null;
alter table m2m_submission add column m2m_submitted_at timestamp null;
alter table m2m_submission add column m2m_finalized_at timestamp null;
alter table m2m_submission add column m2m_next_poll_at timestamp null;
alter table m2m_submission add column m2m_last_poll_at timestamp null;
