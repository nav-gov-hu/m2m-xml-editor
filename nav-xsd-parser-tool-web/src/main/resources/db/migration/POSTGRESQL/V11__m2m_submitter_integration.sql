...
create index if not exists idx_m2m_submission_status on m2m_submission(internal_status);
create index if not exists idx_m2m_submission_ugy on m2m_submission(nav_ugy_azonosito);
create index if not exists idx_m2m_attachment_submission on m2m_attachment(submission_id);
create index if not exists idx_m2m_submission_file_submission on m2m_submission_file(submission_id);
create index if not exists idx_m2m_submission_file_role on m2m_submission_file(file_role);
create index if not exists idx_m2m_submission_file_nav_file on m2m_submission_file(nav_file_id);
